...
const (
	...
	// alpha: v1.23
	//
	// 无论 PV-PVC 删除排序如何，当持久卷回收策略为 "删除 "时，都尊重持久卷回收策略。
...
var defaultKubernetesFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	Topology:                       {Default: true, PreRelease: featuregate.GA},     // csi的
	HonorPVReclaimPolicy:           {Default: false, PreRelease: featuregate.Alpha}, // k8s的
	CrossNamespaceVolumeDataSource: {Default: false, PreRelease: featuregate.Alpha}, // k8s的
	VolumeAttributesClass:          {Default: false, PreRelease: featuregate.Alpha}, // k8s的
}
